...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%
        ...
        {
            // Handle the case when Session["imageUrl"] is null
                                    ...
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-info" id="connectedServices-tab" data-toggle="tab" href="#connectedServices"
                                                ...
                                                <i class="fa fa-clock-o mr-2">Purchased History</i>
                                            </a>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div class="container">
                                                        <div class="row pt-1 pb-1" style="background-color:lightgray">
                                                            <div class="col-4">
                                                                ...
                                                                Payment Mode: <%# Eval("PaymentMode").ToString() == "codd" ? "Cash On Delivery" : Eval("PaymentMode").ToString().ToUpper() %>
                                                            </div>
                                                            <div class="col-6">
