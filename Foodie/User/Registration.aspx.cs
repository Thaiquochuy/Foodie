        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (fuUserImage.HasFile)
            {
                if (Utils.IsvalidExtension(fuUserImage.FileName))
                {
                    ...
                    imagePath = "Images/User/" + obj.ToString() + fileExtenstion;
                    fuUserImage.PostedFile.SaveAs(Server.MapPath("~/Images/User/") + obj.ToString() + fileExtenstion);
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    actionName = UserId == 0 ?
                        ...
                        "datails updated successful! <b><a href='Profile.aspx'>Can check here</a></b>";
                    lblMsg.Visible= true;
